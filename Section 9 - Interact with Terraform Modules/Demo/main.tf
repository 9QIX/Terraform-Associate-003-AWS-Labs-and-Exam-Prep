...
output "module_public_ip" {
  value = module.server_module.public_ip
}

output "module_public_dns" {
  value = module.server_module.public_dns
}

output "size_of_module_instance" {
  value = module.server_module.size
}
